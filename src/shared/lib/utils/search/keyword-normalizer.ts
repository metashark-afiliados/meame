...
logger.trace("[keyword-normalizer.ts] Módulo de normalización de palabras clave cargado y listo para usar.");
...
const STOP_WORDS: ReadonlySet<string> = new Set([
  "a", "an", "the", "and", "or", "but", "about", "above", "after", "again", "against", "all", "am", "is", "are", "as", "at", "be", "because", "been", "before", "being", "below", "between", "both", "by", "can", "could", "did", "do", "does", "doing", "down", "during", "each", "few", "for", "from", "further", "had", "has", "have", "having", "he", "her", "here", "hers", "him", "his", "how", "i", "if", "in", "into", "it", "its", "just", "me", "more", "most", "my", "no", "nor", "not", "of", "off", "on", "once", "only", "or", "other", "our", "out", "over", "own", "s", "same", "she", "should", "so", "some", "such", "t", "than", "that", "then", "there", "these", "they", "this", "those", "through", "to", "too", "under", "until", "up", "very", "was", "we", "were", "what", "when", "where", "which", "while", "who", "whom", "why", "with", "you", "your",

  // Italian stop words
  "il", "la", "lo", "i", "gli", "le", "un", "una", "uno", "di", "a", "da", "in", "con", "su", "per", "tra", "fra", "e", "o", "ma", "se", "che", "chi", "cosa", "dove", "come", "quando", "perché", "non", "mi", "ti", "ci", "vi", "si", "ne", "lo", "la", "li", "le", "gli", "cui", "c'è", "c'era", "c'erano", "c'è stato", "c'è stata", "c'è stati", "c'è state"
]);
