// Ruta correcta: src/components/features/bavi/_components/AssetUploader/_components/AssetUploaderForm.tsx
/**
 * @file AssetUploaderForm.tsx
 * @description Componente de presentación puro para la UI del AssetUploader.
 * @version 4.0.0 (FSD Architecture Alignment & Import Integrity Restoration)
